    ...
    public function hookAdminStatsModules($params)
    {
        ...
        $html .= '
			...
			<ul class="list-group">
				...
				<li class="list-group-item">'.$this->returnLine(Translate::getModuleTranslation('statsmodule', 'Average number of page visits:'), '<span class="badge">'.number_format((float) $average_viewed, 2, '.', '', 'statsmodule')).'</span></li>
				<li class="list-group-item">'.$this->returnLine(Translate::getModuleTranslation('statsmodule', 'Average number of purchases:'), '<span class="badge">'.number_format((float) $average_purchase, 2, '.', '', 'statsmodule')).'</span></li>
				...
				<li class="list-group-item">'.$this->returnLine(Translate::getModuleTranslation('statsmodule', 'Average number of images:'), '<span class="badge">'.number_format((float) $average_pictures, 2, '.', '', 'statsmodule')).'</span></li>
